!function(t, e) {
    ...
    return function(t) {
        ...
        return e.prototype.set = function(t, i, n) {
            var s,
                o,
                r,
                a,
                ...
                l,
                u;
            this.isObject(t) ? n = i : this.isString(t) && (s = {}, s[t] = i, t = s);
            t:
            for (o in t) {
                if (i = t[o], r = this, o.indexOf(".") !== -1) {
                ...
                u = r[o], this.isUndef(u) || (e.Signal && u instanceof e.Signal || e.Param && u instanceof e.Param ? u.value !== i && (this.isUndef(n) ? u.value = i : u.rampTo(i, n)) : u instanceof AudioParam ? u.value !== i && (u.value = i) : u instanceof e ? u.set(i) : u !== i && (r[o] = i))
            }
            return this
            ...
            var i,
                ...
                l,
                u;
            for (this.isUndef(t) ? t = this._collectDefaults(this.constructor) : this.isString(t) && (t = [t]), i = {}, n = 0; n < t.length; n++) {
                if (s = t[n], o = this, r = i, s.indexOf(".") !== -1) {
                    for (a = s.split("."), h = 0; h < a.length - 1; h++)
                        l = a[h], r[l] = r[l] || {}, r = r[l], o = o[l];
                    s = a[a.length - 1]
                }
                u = o[s], this.isObject(t[s]) ? r[s] = u.get() : e.Signal && u instanceof e.Signal ? r[s] = u.value : e.Param && u instanceof e.Param ? r[s] = u.value : u instanceof AudioParam ? r[s] = u.value : u instanceof e ? r[s] = u.get() : this.isFunction(u) || this.isUndef(u) || (r[s] = u)
            }
            return i
            ...
            var e,
                i,
                n = [];
            if (this.isUndef(t.defaults) || (n = Object.keys(t.defaults)), !this.isUndef(t._super))
                for (e = this._collectDefaults(t._super), i = 0; i < e.length; i++)
                    n.indexOf(e[i]) === -1 && n.push(e[i]);
            return n
            ...
            var t,
                ...
                n;
            for (t in e)
                if (i = t[0].match(/^[A-Z]$/), n = e[t] === this.constructor, this.isFunction(e[t]) && i && n)
                    return t;
            return "Tone"
        }, Object.defineProperty(e.prototype, "numberOfInputs", {
            get: function() {
                return this.input ? this.isArray(this.input) ? this.input.length : 1 : 0
            }
        }), Object.defineProperty(e.prototype, "numberOfOutputs", {
            get: function() {
        ...
        }, e.prototype.connectSeries = function() {
            var t,
                e,
                i;
            ...
            if (arguments.length > 0)
                for (t = this, e = 0; e < arguments.length; e++)
                    i = arguments[e], t.connect(i), t = i;
            return this
        }, e.prototype.fan = function() {
            if (arguments.length > 0)
                for (var t = 0; t < arguments.length; t++)
                    this.connect(arguments[t]);
            return this
        }, AudioNode.prototype.chain = e.prototype.chain, AudioNode.prototype.fan = e.prototype.fan, e.prototype.defaultArg = function(t, e) {
            var i,
                n,
                s;
            if (this.isObject(t) && this.isObject(e)) {
                ...
                for (s in e)
                    i[s] = this.defaultArg(t[s], e[s]);
                return i
            }
            return this.isUndef(t) ? e : t
        }, e.prototype.optionsObject = function(t, e, i) {
            var n,
                s = {};
            if (1 === t.length && this.isObject(t[0]))
                ...
                for (n = 0; n < e.length; n++)
                    s[e[n]] = t[n];
            return this.isUndef(i) ? s : this.defaultArg(s, i)
        }, e.prototype.isUndef = function(t) {
            return void 0 === t
        ...
        }, e.prototype.isBoolean = function(t) {
            return "boolean" == typeof t
        }, e.prototype.isArray = function(t) {
            return Array.isArray(t)
        }, e.prototype.isString = function(t) {
            ...
            Stopped: "stopped",
            Paused: "paused"
        }, e.prototype.equalPowerScale = function(t) {
            var e = .5 * Math.PI;
            return Math.sin(t * e)
        }, e.prototype.dbToGain = function(t) {
            return Math.pow(2, t / 6)
        }, e.prototype.gainToDb = function(t) {
            return Math.log(t) / Math.LN10 * 20
        }, e.prototype.intervalToFrequencyRatio = function(t) {
            ...
            function n() {}
            e.prototype.isUndef(i) && (i = e), n.prototype = i.prototype, t.prototype = new n, t.prototype.constructor = t, t._super = i
        }, Object.defineProperty(e, "context", {
            get: function() {
                return t
            },
            set: function(i) {
                t = e.Context && i instanceof e.Context ? i : new e.Context(i), e.Context && e.Context.emit("init", t)
            }
        ...
        }), e.version = "r10", window.TONE_SILENCE_VERSION_LOGGING || console.log("%c * Tone.js " + e.version + " * ", "background: #000; color: #fff"), e
    }), t(function(t) {
        ...
        return t.TimeBase = function(e, i) {
            ...
            for (var e, i = -1, n = []; t.length > 0;)
                t = t.trim(), e = function(t, e) {
                    var i,
                        n,
                        s,
                        o,
                        r,
                        a,
                        h = ["_binaryExpressions", "_unaryExpressions", "_primaryExpressions", "_syntaxGlue"];
                    for (i = 0; i < h.length; i++) {
                        n = e[h[i]];
                        for (s in n)
                            if (o = n[s], r = o.regexp, null !== (a = t.match(r)))
                                return {
                                    method: o.method,
            ...
            if (!this.isUndef(t))
                for (n in e)
                    if (s = e[n], s.regexp.test(t.value)) {
                        if (this.isUndef(i))
                            return s;
                        if (s.precedence === i)
                            return s
            ...
            var i,
                n;
            for (this.isUndef(e) && (e = 2), i = e < 0 ? this._parseUnary(t) : this._parseBinary(t, e - 1), n = t.peek(); n && this._matchGroup(n, this._binaryExpressions, e);)
            ...
            if (this._matchGroup(n, this._primaryExpressions))
                return n = t.next(), i = n.value.match(n.regexp), n.method.bind(this, i[1], i[2], i[3]);
            if (n && "(" === n.value) {
                if (t.next(), e = this._parseBinary(t), !(n = t.next()) || ")" !== n.value)
                    throw new SyntaxError("Expected )");
                return e
            }
            throw new SyntaxError("Tone.TimeBase: Cannot process token " + n.value)
        }, t.TimeBase.prototype._parseExprString = function(t) {
            var e;
            return this.isString(t) || (t = t.toString()), e = this._tokenize(t), this._parseBinary(e)
        ...
        return t.Time = function(e, i) {
            ...
            for (i = 0; i < e.length; i++)
                if (n = this._notationToUnits(e[i]), s = t / n, o = 1e-6, 1 - s % 1 < o && (s += o), (s = Math.floor(s)) > 0) {
                    if (a += 1 === s ? e[i] : s.toString() + "*" + e[i], (t -= s * n) < r)
                        break;
                    a += " + "
                }
            return "" === a && (a = "0"), a
            ...
            var e,
                i,
                n,
                s = this._primaryExpressions,
                o = [s.n, s.t, s.m];
            for (e = 0; e < o.length; e++)
                if (i = o[e], n = t.match(i.regexp))
                    return i.method.call(this, n[1])
            ...
            var t,
                ...
                s = i % 1 * 4;
            return i = Math.floor(i) % this._timeSignature(), s = s.toString(), s.length > 3 && (s = parseFloat(s).toFixed(3)), t = [n, i, s], t.join(":")
        ...
        return t.Frequency = function(e, i) {
            ...
            return this._expr = function(t, e) {
                var i,
                    ...
                    s = [];
                for (i = 0; i < e.length; i++)
                    s[i] = n * this.intervalToFrequencyRatio(e[i]);
                return s
            }.bind(this, this._expr, t), this
        ...
        return t.Emitter = function() {
            ...
            if (this._events && (e = Array.apply(null, arguments).slice(1), this._events.hasOwnProperty(t)))
                for (i = this._events[t], n = 0, s = i.length; n < s; n++)
                    i[n].apply(this, e);
            return this
        ...
        return !window.hasOwnProperty("AudioContext") && window.hasOwnProperty("webkitAudioContext") && (window.AudioContext = window.webkitAudioContext), t.Context = function(e) {
            ...
            var t,
                e,
                i;
            return window.URL = window.URL || window.webkitURL, t = new Blob(["var timeoutTime = " + (1e3 * this._updateInterval).toFixed(1) + ";self.onmessage = function(msg){\ttimeoutTime = parseInt(msg.data);};function tick(){\tsetTimeout(tick, timeoutTime);\tself.postMessage('tick');}tick();"]), e = URL.createObjectURL(t), i = new Worker(e), i.addEventListener("message", function() {
                this.emit("tick")
            ...
            function e(e, i, s) {
                if (e.input)
                    Array.isArray(e.input) ? (t.prototype.isUndef(s) && (s = 0), this.connect(e.input[s])) : this.connect(e.input, i, s);
                else
                    try {
        ...
        return t.Timeline = function() {
            ...
            return this._timeline.length ? (e = this._search(t.time), this._timeline.splice(e + 1, 0, t)) : this._timeline.push(t), this.length > this.memory && (i = this.length - this.memory, this._timeline.splice(0, i)), this
            ...
            return i > 0 && this._timeline[i - 1].time < t ? this._timeline[i - 1] : (e = this._search(t), e - 1 >= 0 ? this._timeline[e - 1] : null)
            ...
            var e,
                ...
                h = a;
            if (a > 0 && this._timeline[a - 1].time <= t)
                return a - 1;
            for (; r < h;) {
                if (e = Math.floor(r + (h - r) / 2), i = this._timeline[e], n = this._timeline[e + 1], i.time === t) {
                    for (s = e; s < this._timeline.length; s++)
                        o = this._timeline[s], o.time === t && (e = s);
                    return e
                }
                if (i.time < t && n.time > t)
                    return e;
                i.time > t ? h = e : i.time < t && (r = e + 1)
            }
            return -1
            ...
            var n,
                s,
                o;
            for (this._iterating = !0, e = this.defaultArg(e, 0), i = this.defaultArg(i, this._timeline.length - 1), n = e; n <= i; n++)
                t(this._timeline[n]);
            if (this._iterating = !1, this._toRemove.length > 0) {
                for (s = 0; s < this._toRemove.length; s++)
                    (o = this._timeline.indexOf(this._toRemove[s])) !== -1 && this._timeline.splice(o, 1);
                this._toRemove = []
            }
        ...
        return t.TimelineSignal = function() {
            ...
            var o,
                ...
                a,
                h;
            for (s = this.defaultArg(s, 1), o = new Array(e.length), r = 0; r < o.length; r++)
                o[r] = this._fromUnits(e[r]) * s;
            for (i = this.toSeconds(i), n = this.toSeconds(n), this._events.add({
                type: t.TimelineSignal.Type.Curve,
                value: o,
                time: i,
                duration: n
            }), this._param.setValueAtTime(o[0], i), a = 1; a < o.length; a++)
                h = i + a / (o.length - 1) * n, this._param.linearRampToValueAtTime(o[a], h);
            return this
            ...
            var i,
                n,
                s;
            return e = this.toSeconds(e), i = this._toUnits(this.getValueAtTime(e)), n = this._searchBefore(e), n && n.time === e ? this.cancelScheduledValues(e + this.sampleTime) : n && n.type === t.TimelineSignal.Type.Curve && n.time + n.duration > e ? (this.cancelScheduledValues(e), this.linearRampToValueAtTime(i, e)) : (s = this._searchAfter(e), s && (this.cancelScheduledValues(e), s.type === t.TimelineSignal.Type.Linear ? this.linearRampToValueAtTime(i, e) : s.type === t.TimelineSignal.Type.Exponential && this.exponentialRampToValueAtTime(i, e)), this.setValueAtTime(i, e)), this
            ...
            var i,
                ...
                o,
                r;
            return e = this.toSeconds(e), i = this._searchAfter(e), n = this._searchBefore(e), s = this._initial, null === n ? s = this._initial : n.type === t.TimelineSignal.Type.Target ? (o = this._events.getBefore(n.time), r = null === o ? this._initial : o.value, s = this._exponentialApproach(n.time, r, n.value, n.constant, e)) : s = n.type === t.TimelineSignal.Type.Curve ? this._curveInterpolate(n.time, n.value, n.duration, e) : null === i ? n.value : i.type === t.TimelineSignal.Type.Linear ? this._linearInterpolate(n.time, n.value, i.time, i.value, e) : i.type === t.TimelineSignal.Type.Exponential ? this._exponentialInterpolate(n.time, n.value, i.time, i.value, e) : n.value, s
            ...
            var s,
                ...
                h,
                l = e.length;
            return n >= t + i ? e[l - 1] : n <= t ? e[0] : (s = (n - t) / i, o = Math.floor((l - 1) * s), r = Math.ceil((l - 1) * s), a = e[o], h = e[r], r === o ? a : this._linearInterpolate(o, a, r, h, s * (l - 1)))
        ...
        return t.Envelope = function() {
            ...
            var i,
                ...
                d = [];
            for (i = 0; i < f; i++)
                d[i] = Math.sin(i / (f - 1) * (Math.PI / 2));
            for (s = [], o = 6.4, i = 0; i < f - 1; i++)
                n = i / (f - 1), r = Math.sin(n * (2 * Math.PI) * o - Math.PI / 2) + 1, s[i] = r / 10 + .83 * n;
            for (s[f - 1] = 1, a = [], h = 5, i = 0; i < f; i++)
                a[i] = Math.ceil(i / (f - 1) * h) / h;
            for (l = [], i = 0; i < f; i++)
                n = i / (f - 1), l[i] = .5 * (1 - Math.cos(Math.PI * n));
            for (u = [], i = 0; i < f; i++)
                n = i / (f - 1), p = 4 * Math.pow(n, 3) + .2, c = Math.cos(p * Math.PI * 2 * n), u[i] = Math.abs(c * (1 - n));
            t.Envelope.Type = {
                linear: "linear",
                exponential: "exponential",
                bounce: {
            ...
            set: function(e) {
                if (e === t.Analyser.ReturnType.Byte)
                    ...
                    if (e !== t.Analyser.ReturnType.Float)
                        throw new TypeError("Tone.Analayser: invalid return type: " + e);
        ...
        return t.Expr = function() {
            var t,
                e,
                i,
                n = this._replacements(Array.prototype.slice.call(arguments)),
                s = this._parseInputs(n);
            for (this._nodes = [], this.input = new Array(s), t = 0; t < s; t++)
            ...
            if (null !== n)
                for (e = 0; e < n.length; e++)
                    i = parseInt(n[e].substr(1)) + 1, s = Math.max(s, i);
            return s
            ...
            for (var i, n = -1, s = []; e.length > 0;)
                e = e.trim(), i = function(e) {
                    var i,
                        n,
                        s,
                        o,
                    ...
                    for (i in t.Expr._Expressions) {
                        ...
                        for (s in n)
                            if (o = n[s], r = o.regexp, null !== (a = e.match(r)))
                                return {
                                    type: i,
                                    value: a[0],
                                    method: o.method
            ...
            function s(t) {
                var e,
                    i;
                for (u(t) && (t = 5), e = t < 0 ? o() : s(t - 1), i = l.peek(); n(i, "binary", t);)
                    i = l.next(), e = {
                        operator: i.value,
                        method: i.method,
                        args: [e, s(t - 1)]
            ...
            function o() {
                var t,
                    e;
                return t = l.peek(), n(t, "unary") ? (t = l.next(), e = o(), {
                    operator: t.value,
                    method: t.method,
                    args: [e]
                }) : r()
            ...
            function a(t) {
                ...
                if (e = l.peek(), i(e, ")") || (n = h()), e = l.next(), !i(e, ")"))
                    throw new SyntaxError('Tone.Expr: Expected ) in a function call "' + t.value + '"');
                return {
                    method: t.method,
                    args: n,
        ...
        return t.Filter = function() {
            ...
            set: function(t) {
                var e;
                if (["lowpass", "highpass", "bandpass", "lowshelf", "highshelf", "notch", "allpass", "peaking"].indexOf(t) === -1)
            ...
            set: function(t) {
                var e,
                    ...
                    o,
                    r;
                if (t = parseInt(t, 10), e = [-12, -24, -48, -96], (i = e.indexOf(t)) === -1)
                    throw new RangeError("Tone.Filter: rolloff can only be -12, -24, -48 or -96");
                for (i += 1, this._rolloff = t, this.input.disconnect(), n = 0; n < this._filters.length; n++)
                    this._filters[n].disconnect(), this._filters[n] = null;
                for (this._filters = new Array(i), s = 0; s < i; s++)
                    o = this.context.createBiquadFilter(), o.type = this._type, this.frequency.connect(o.frequency), this.detune.connect(o.detune), this.Q.connect(o.Q), this.gain.connect(o.gain), this._filters[s] = o;
        ...
        t.IntervalTimeline = function() {
            ...
            for (null === this._root ? this._root = i : this._root.insert(i), this._length++; null !== i;)
            ...
            var i,
                ...
                s;
            if (null !== this._root)
                for (i = [], this._root.searchAfter(t, i), n = i.length - 1; n >= 0; n--)
                    (s = i[n].event) && e(s);
            return this
        ...
        t.Transport = function() {
            ...
            }.bind(this)), this._onceEvents.cancelBefore(s), this._timeline.forEachAtTime(s, function(t) {
                t.callback(e)
            }), this._repeatedEvents.forEachAtTime(s, function(t) {
                (s - t.time) % t.interval == 0 && t.callback(e)
            })
        ...
        return t.Source = function(e) {
            ...
            var s,
                o;
            return e = this.isUndef(e) && this._synced ? t.Transport.seconds : this.toSeconds(e), this.retrigger || this._state.getValueAtTime(e) !== t.State.Started || this.stop(e), this._state.setStateAtTime(t.State.Started, e), this._synced ? (s = this._state.get(e), s.offset = this.defaultArg(i, 0), s.duration = n, o = t.Transport.schedule(function(t) {
                this._start(t, i, n)
            ...
            var e,
                i;
            for (this._synced = !1, t.Transport.off("start stop pause loopEnd loopStart"), e = 0; e < this._scheduled.length; e++)
        ...
        return window.OscillatorNode && !OscillatorNode.prototype.start && (OscillatorNode.prototype.start = OscillatorNode.prototype.noteOn, OscillatorNode.prototype.stop = OscillatorNode.prototype.noteOff, OscillatorNode.prototype.setPeriodicWave || (OscillatorNode.prototype.setPeriodicWave = OscillatorNode.prototype.setWaveTable), AudioContext.prototype.createPeriodicWave || (AudioContext.prototype.createPeriodicWave = AudioContext.prototype.createWaveTable)), t.Oscillator = function() {
            ...
            var n,
                ...
                p = 1;
            for (e === t.Oscillator.Type.Custom ? (p = this._partials.length + 1, h = p) : (n = /^(sine|triangle|square|sawtooth)(\d+)$/.exec(e)) && (p = parseInt(n[2]) + 1, e = n[1], p = Math.max(p, 2), h = p), s = 1; s < h; ++s) {
        ...
        return t.Meter = function() {
            ...
            get: function() {
                var e,
                    ...
                    s,
                    o,
                    r = this._analyser.analyse();
                if (this.type === t.Meter.Type.Level) {
                    for (e = 0, i = 0; i < r.length; i++)
                        e += Math.pow(r[i], 2);
                    return n = Math.sqrt(e / r.length), n = Math.max(n, this._lastValue * this.smoothing), this._lastValue = n, s = .35, o = n / s, Math.sqrt(o)
                }
                return r[0]
            }
        ...
        return t.CtrlInterpolate = function() {
            ...
            if (this.isArray(e)) {
                for (n = [], s = 0; s < e.length; s++)
                    n[s] = this._interpolate(t, e[s], i[s]);
                return n
            }
            if (this.isObject(e)) {
                o = {};
        ...
        return t.CtrlMarkov = function(t, e) {
            ...
            if (this.values.hasOwnProperty(this.value))
                if (t = this.values[this.value], this.isArray(t))
                    for (e = this._getProbDistribution(t), i = Math.random(), n = 0, s = 0; s < e.length; s++)
                        o = e[s], i > n && i < n + o && (r = t[s], this.isObject(r) ? this.value = r.value : this.value = r), n += o;
                else
                    this.value = t;
            return this.value
            ...
            var e,
                ...
                r = !1;
            for (e = 0; e < t.length; e++)
                i = t[e], this.isObject(i) ? (r = !0, s[e] = i.probability) : s[e] = 1 / t.length, o += s[e];
            if (r)
        ...
        return window.AudioBuffer && !AudioBuffer.prototype.copyToChannel && (AudioBuffer.prototype.copyToChannel = function(t, e, i) {
            ...
            if (this.isNumber(t))
                ...
                for (e = new Float32Array(this.length), i = this.numberOfChannels, n = 0; n < i; n++)
                    for (s = this.toArray(n), o = 0; o < s.length; o++)
                        e[o] += s[o];
                e = e.map(function(t) {
                    return t / i
                }), this.fromArray(e)
            ...
            for (e = [], i = 0; i < this.numberOfChannels; i++)
            ...
            var n,
                ...
                o,
                r;
            for (i = this.defaultArg(i, this.duration), n = Math.floor(this.context.sampleRate * this.toSeconds(e)), s = Math.floor(this.context.sampleRate * this.toSeconds(i)), o = [], r = 0; r < this.numberOfChannels; r++)
            ...
            return r.open("GET", t.Buffer.baseUrl + e, !0), r.responseType = "arraybuffer", r.progress = 0, t.Buffer._currentDownloads++, t.Buffer._downloadQueue.push(r), r.addEventListener("load", function() {
                200 === r.status ? t.context.decodeAudioData(r.response, function(e) {
                    r.progress = 1, o(), i(e), 0 === --t.Buffer._currentDownloads && (t.Buffer._downloadQueue = [], t.Buffer.emit("load"))
                }, function() {
                    s("Tone.Buffer: could not decode audio data: " + e)
                }) : s("Tone.Buffer: could not locate file: " + e)
            }), r.addEventListener("error", s), r.addEventListener("progress", function(t) {
        ...
        return t.Buffers = function(t, e, i) {
            ...
            for (var n in t)
                this._loadingCount++, this.add(n, t[n], this._bufferLoaded.bind(this, e))
        ...
        t.Listener = function() {
            ...
            if (this.context.listener.forwardX) {
                ...
                this.context.listener.setOrientation(t, e, i, n, s, o);
            return this._orientation = Array.prototype.slice.call(arguments), this
        ...
        return !window.hasOwnProperty("OfflineAudioContext") && window.hasOwnProperty("webkitOfflineAudioContext") && (window.OfflineAudioContext = window.webkitOfflineAudioContext), t.OfflineContext = function(e, i, n) {
            ...
            for (; this._duration - this._currentTime >= 0;)
                this.emit("tick"), this._currentTime += t.prototype.blockTime;
        ...
        return t.Freeverb = function() {
            var n,
                ...
                a,
                h,
                l = this.optionsObject(arguments, ["roomSize", "dampening"], t.Freeverb.defaults);
        ...
        return t.JCReverb = function() {
            var s,
                ...
                r,
                a,
                h = this.optionsObject(arguments, ["roomSize"], t.JCReverb.defaults);
        ...
        return t.Phaser = function() {
            ...
            var n,
                ...
                o = new Array(t);
            for (n = 0; n < t; n++)
                s = this.context.createBiquadFilter(), s.type = "allpass", i.connect(s.Q), e.connect(s.frequency), o[n] = s;
        ...
        return t.Part = function() {
            var e,
                i,
                n = this.optionsObject(arguments, ["callback", "events"], t.Part.defaults);
            if (this._loop = n.loop, this._loopStart = this.toTicks(n.loopStart), this._loopEnd = this.toTicks(n.loopEnd), this._playbackRate = n.playbackRate, this._probability = n.probability, this._humanize = n.humanize, this._startOffset = 0, this._state = new t.TimelineState(t.State.Stopped), this._events = [], this.callback = n.callback, this.mute = n.mute, e = this.defaultArg(n.events, []), !this.isUndef(n.events))
                for (i = 0; i < e.length; i++)
            ...
            for (e = t.TransportTime(e), n = t.Time(1, "i").toSeconds(), s = 0; s < this._events.length; s++)
                if (o = this._events[s], Math.abs(e.toTicks() - o.startOffset) < n)
                    return this.isUndef(i) || (o.value = i), o;
            ...
            for (e.hasOwnProperty("time") && (i = e, e = i.time), e = this.toTicks(e), n = this._events.length - 1; n >= 0; n--)
                s = this._events[n], s instanceof t.Part ? s.remove(e, i) : s.startOffset === e && (this.isUndef(i) || !this.isUndef(i) && s.value === i) && (this._events.splice(n, 1), s.dispose());
            return this
            ...
            var n,
                s;
            for (i = this.defaultArg(i, this), n = this._events.length - 1; n >= 0; n--)
        ...
        return t.Sequence = function() {
            var e,
                ...
                n = i.events;
            if (delete i.events, t.Part.call(this, i), this._subdivision = this.toTicks(i.subdivision), this.isUndef(i.loopEnd) && !this.isUndef(n) && (this._loopEnd = n.length * this._subdivision), this._loop = !0, !this.isUndef(n))
                for (e = 0; e < n.length; e++)
                    this.add(e, n[e])
            ...
            set: function(e) {
                ...
                if (e = Math.max(e, 1), this._oscillators.length !== e) {
                    for (this._forEach(function(t) {
                        ...
                        n = new t.Oscillator, this.type === t.Oscillator.Type.Custom ? n.partials = this._partials : n.type = this._type, n.phase = this._phase, n.volume.value = -6 - e, this.frequency.connect(n.frequency), this.detune.connect(n.detune), n.connect(this.output), this._oscillators[i] = n;
        ...
        return t.OmniOscillator.prototype._start = function(t) {
            ...
            var i,
                n,
                s;
            e !== this._sourceType && (this._sourceType = e, i = t[e], n = this.now() + this.blockTime, null !== this._oscillator && (s = this._oscillator, s.stop(n), setTimeout(function() {
                s.dispose(), s = null
            }, 1e3 * this.blockTime)), this._oscillator = new i, this.frequency.connect(this._oscillator.frequency), this.detune.connect(this._oscillator.detune), this._oscillator.connect(this.output), this.state === t.State.Started && this._oscillator.start(n))
        ...
        return t.MetalSynth = function(i) {
            var n,
                s,
                o;
            for (i = this.defaultArg(i, t.MetalSynth.defaults), t.Instrument.call(this, i), this.frequency = new t.Signal(i.frequency, t.Type.Frequency), this._oscillators = [], this._freqMultipliers = [], this._amplitue = new t.Gain(0).connect(this.output), this._highpass = new t.Filter({
                type: "highpass",
                ...
                }), s.connect(this._highpass).start(0), this._oscillators[n] = s, o = new t.Multiply(e[n]), this._freqMultipliers[n] = o, this.frequency.chain(o, s.frequency);
        ...
        return window.AudioBufferSourceNode && !AudioBufferSourceNode.prototype.start && (AudioBufferSourceNode.prototype.start = AudioBufferSourceNode.prototype.noteGrainOn, AudioBufferSourceNode.prototype.stop = AudioBufferSourceNode.prototype.noteOff), t.BufferSource = function() {
            ...
            get: function() {
                var e = this.now();
                return this._startTime !== -1 && e >= this._startTime && e < this._stopTime ? t.State.Started : t.State.Stopped
            }
        ...
        return t.Noise = function() {
            ...
            pink: function() {
                var t,
                    ...
                    f = [];
                for (t = 0; t < n; t++)
                    for (e = new Float32Array(i), f[t] = e, s = o = r = a = h = l = u = 0, p = 0; p < i; p++)
                        c = 2 * Math.random() - 1, s = .99886 * s + .0555179 * c, o = .99332 * o + .0750759 * c, r = .969 * r + .153852 * c, a = .8665 * a + .3104856 * c, h = .55 * h + .5329522 * c, l = -.7616 * l - .016898 * c, e[p] = s + o + r + a + h + l + u + .5362 * c, e[p] *= .11, u = .115926 * c;
                return f
            }(),
            brown: function() {
                var t,
        ...
        }, o = {}, e(), t.Context.on("init", e), t.Noise
    }), t(function(t) {
        ...
        return t.PolySynth = function() {
            var e,
                i,
                n;
            for (t.Instrument.call(this), e = this.optionsObject(arguments, ["polyphony", "voice"], t.PolySynth.defaults), e = this.defaultArg(e, t.Instrument.defaults), e.polyphony = Math.min(t.PolySynth.MAX_POLYPHONY, e.polyphony), this.voices = new Array(e.polyphony), this._triggers = new Array(e.polyphony), this.detune = new t.Signal(e.detune, t.Type.Cents), this._readOnly("detune"), i = 0; i < e.polyphony; i++)
                n = new e.voice(arguments[2], arguments[3]), this.voices[i] = n, n.connect(this.output), n.hasOwnProperty("detune") && this.detune.connect(n.detune), this._triggers[i] = {
                    release: -1,
                    note: null,
                    voice: n
                };
            ...
            for (Array.isArray(t) || (t = [t]), e = this.toSeconds(e), n = 0; n < t.length; n++) {
                for (s = t[n], o = this._triggers[0], 0, r = 1; r < this._triggers.length; r++)
                    this._triggers[r].release < o.release && (o = this._triggers[r], r);
            ...
            if (i = this.toSeconds(i), this.triggerAttack(t, i, n), this.isArray(e) && this.isArray(t))
                for (s = 0; s < t.length; s++)
                    o = e[Math.min(s, e.length - 1)], this.triggerRelease(t[s], i + this.toSeconds(o));
            else
        ...
        return t.Player = function(e) {
            ...
            if (i = this._loop ? this.defaultArg(i, this._loopStart) : this.defaultArg(i, 0), i = this.toSeconds(i), n = this.defaultArg(n, Math.max(this._buffer.duration - i, 0)), n = this.toSeconds(n), e = this.toSeconds(e), this._source = this.context.createBufferSource(), this._source.buffer = this._buffer.get(), this._loop ? (this._source.loop = this._loop, this._source.loopStart = this.toSeconds(this._loopStart), this._source.loopEnd = this.toSeconds(this._loopEnd)) : this._synced || this._state.setStateAtTime(t.State.Stopped, e + n), this._source.playbackRate.value = this._playbackRate, this._source.connect(this.output), this._loop) {
                if (s = this._source.loopEnd || this._buffer.duration, o = this._source.loopStart, r = s - o, i > s)
                    for (; i > s;)
                        i -= r;
                this._source.start(e, i)
            } else
                this._source.start(e, i, n);
            return this
        ...
        return t.MultiPlayer = function() {
            ...
            var i,
                n;
            return this.isString(e) || this.isNumber(e) ? i = this.buffers.get(e).get() : e instanceof t.Buffer ? i = e.get() : e instanceof AudioBuffer && (i = e), n = new t.BufferSource(i).connect(this.output), this._activeSources.hasOwnProperty(e) || (this._activeSources[e] = []), this._activeSources[e].push(n), n
            ...
            return a.loop = !0, a.loopStart = this.toSeconds(this.defaultArg(n, 0)), a.loopEnd = this.toSeconds(this.defaultArg(s, 0)), a.start(e, i, void 0, this.defaultArg(r, 1), this.fadeIn), o = this.defaultArg(o, 0), a.playbackRate.value = this.intervalToFrequencyRatio(o), this
        }, t.MultiPlayer.prototype.stop = function(t, e) {
            if (!this._activeSources[t] || !this._activeSources[t].length)
            ...
            for (e in this._activeSources)
                for (i = this._activeSources[e], n = 0; n < i.length; n++)
                    i[n].stop(t);
            return this
        ...
        return t.GrainPlayer = function() {
            ...
            var e,
                ...
                o,
                r,
                a = this.buffer.duration;
            this.loop && this._loopEnd > 0 && (a = this._loopEnd), e = (2 * Math.random() - 1) * this.drift, i = this._offset - this._overlap + e, n = this.detune / 100, i = Math.max(i, 0), i = Math.min(i, a), s = this._player.fadeIn, this.loop && this._offset > a ? (o = this._offset - a, this._player.start(this.buffer, t, i, o + this._overlap, n), i = this._offset % a, this._offset = this._loopStart, this._player.fadeIn = 0, this._player.start(this.buffer, t + o, this._offset, i + this._overlap, n)) : this._offset > a ? this.stop(t) : (0 === i && (this._player.fadeIn = 0), this._player.start(this.buffer, t, i, this.grainSize + this._overlap, n)), this._player.fadeIn = s, r = this._clock._nextTick - t, this._offset += r * this._playbackRate
